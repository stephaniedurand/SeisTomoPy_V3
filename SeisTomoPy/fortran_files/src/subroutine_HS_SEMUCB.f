ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc  
       subroutine sph2geo2SEMUCB(NS,p,np,radial_basis,
     +            filename,filename2,filename3,pnts,NN,model,dvvst,cd,
     +    dep,width)
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
c       open(1,file='../models/SEMUCB_WM1_5km.sph')
c       cd=1
c       do depth=2890,0,-5
...
c       close(1)
       ...
       open(13,file='../output_files_cross/output_cross_SEMUCBWM1.out')
       open(14,file='../output_files_cross/SEMUCBWM1_input_AxiSEM.sph')
       open(15,file='../output_files_cross/SEMUCBWM1_PathPy.sph')
       write(14,*) (width+1)*cd
       do kk=1,(width+1)
...
c       write(*,*) ll,ind-1
     ...
     + splitf*100.d0,Rrho*100.d0
       write(14,*) 6371-depth,deg,Ralpha*splitf*100.d0,splitf*100.d0,
     + Rrho*splitf*100.d0
       write(15,*) 6371-depth,kk-1,Ralpha*splitf*100.d0,splitf*100.d0,
     + Rrho*splitf*100.d0
