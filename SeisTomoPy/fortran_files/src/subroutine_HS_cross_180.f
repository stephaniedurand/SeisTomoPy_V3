...
!      Definition de la loi de sclaing Ralpha
       ...
       open(13,file='../output_files_cross/output_cross_SEISGLOB2.out')
       open(14,file='../output_files_cross/SEISGLOB2_input_AxiSEM.sph')
       open(15,file='../output_files_cross/SEISGLOB2_PathPy.sph')
...
!      Definition de la loi de sclaing Ralpha
       ...
       open(11,file=trim(adjustl(filename2)))
       open(12,file=trim(adjustl(filename3)))
       open(13,file='../output_files_cross/output_cross_SEISGLOB1.out')
       open(14,file='../output_files_cross/SEISGLOB1_input_AxiSEM.sph')
       open(15,file='../output_files_cross/SEISGLOB1_PathPy.sph')
       write(14,*) (width+1)*579
       do kk=1,width+1
