ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc  
       subroutine sph2geo2YOURMODEL(NS,p,np,radial_basis,
...
c       close(1)
       ...
       open(13,file='../output_files_cross/output_cross_MYMODEL.out')
       open(14,file='../output_files_cross/MYMODEL_input_AxiSEM.sph')
       open(15,file='../output_files_cross/MYMODEL_PathPy.sph')
       write(14,*) (width+1)*cd
       do kk=1,width+1
...
c       write(*,*) ll,ind-1
     ...
     + splitf*100.d0,Rrho*splitf*100.d0
       ...
       end subroutine sph2geo2YOURMODEL
