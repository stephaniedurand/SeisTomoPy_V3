ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc  
       subroutine sph2geo2S362WMANIM(NS,p,np,radial_basis,
...
c       open(1,file='../models/S362WMANIM_5km.sph')
c       cd=1
c       do depth=2890,0,-5
...
c       close(1)
       ...
       open(13,file='../output_files_cross/output_cross_S362WMANIM.out')
       open(14,file='../output_files_cross/S362WMANIM_input_AxiSEM.sph')
       open(15,file='../output_files_cross/S362WMANIM_PathPy.sph')
       write(14,*) (width+1)*cd
       do kk=1,width+1
...
c       write(*,*) ll,ind-1
     ...
     + Rrho*splitf*100.d0
       ...
       end subroutine sph2geo2S362WMANIM
