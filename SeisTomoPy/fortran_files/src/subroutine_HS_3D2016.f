...
c       close(1)
       ...
       open(13,file='../output_files_cross/output_cross_3D2016.out')
       open(14,file='../output_files_cross/3D2016_input_AxiSEM.sph')
       open(15,file='../output_files_cross/3D2016_PathPy.sph')
       write(14,*) (width+1)*cd
       do kk=1,width+1
