ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc  
       subroutine sph2geo2SGLOBE(NS,p,np,radial_basis,
...
c       close(1)
       ...
       open(13,file='../output_files_cross/output_cross_SGLOBE.out')
       open(14,file='../output_files_cross/SGLOBE_input_AxiSEM.sph')
       open(15,file='../output_files_cross/SGLOBE_PathPy.sph')
       write(14,*) (width+1)*cd
       do kk=1,width+1
