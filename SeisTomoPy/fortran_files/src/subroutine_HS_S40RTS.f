ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc  
     ...
     +           dvvst,Ralpha,Rrho,cd,dep,width)
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
...
c       close(1)
       ...
       open(13,file='../output_files_cross/output_cross_S40RTS.out')
       open(14,file='../output_files_cross/S40RTS_input_AxiSEM.sph')
       open(15,file='../output_files_cross/S40RTS_PathPy.sph')
       write(14,*) (width+1)*cd
       do kk=1,width+1
...
c       write(*,*) ll,ind-1
       ...
       enddo
       write(10,*) deg,6371-depth,Ralpha(radius)*splitf*100.d0
       write(11,*) deg,6371-depth,splitf*100.d0
       write(12,*) deg,6371-depth,Rrho*splitf*100.d0
       write(13,*) ttheta,pphi,6371-depth,Ralpha(radius)*splitf*100.d0,
     + splitf*100.d0,Rrho*splitf*100.d0
       write(14,*) 6371-depth,deg,Ralpha(radius)*splitf*100.d0,
     + splitf*100.d0,Rrho*splitf*100.d0
       write(15,*) 6371-depth,kk-1,Ralpha(radius)*splitf*100.d0,
     + splitf*100.d0,Rrho*splitf*100.d0
