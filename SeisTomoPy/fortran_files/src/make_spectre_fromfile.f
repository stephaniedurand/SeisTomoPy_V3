...
c       implicit real*8 (a-h,o-z)
     ...
     + fichier4(nx,ny)
       ...
       character*1000 filemoi1,filemoi2,filemoi3,filemoi4
...
c   read filename
       read(*,'(1000a)') filemoi1
       read(*,*) llmax
c       if (tomo.eq.1) namemodel = "SEISGLOB2"
c       if (tomo.eq.2) namemodel = "S40RTS"
c       if (tomo.eq.3) namemodel = "SEMUCBWM1"
c       if (tomo.eq.4) namemodel = "S362WMANIM"
c       if (para.eq.1) namepara = "VS"
c       if (para.eq.2) namepara = "VP"
c       if (para.eq.3) namepara = "RHO"
c       filemoi1="../input_files/map_NEW_"//trim(adjustl(namemodel))//
c     + "_"//trim(adjustl(namepara))//".xyz"
       filemoi2="../output_files_spectre/spectre_fromfile.xy"
