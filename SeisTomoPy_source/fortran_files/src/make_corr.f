...
c   read filename
       read(*,*) llmax
       read(*,*) tomo1,para1,depth1
       read(*,*) tomo2,para2,depth2
       write(namedepth1,'(i4)') depth1
       write(namedepth2,'(i4)') depth2
       if (tomo1.eq.1) namemodel1 = "SEISGLOB2"
       if (tomo1.eq.2) namemodel1 = "S40RTS"
       if (tomo1.eq.3) namemodel1 = "SEMUCBWM1"
       if (tomo1.eq.4) namemodel1 = "S362WMANIM"
       if (tomo1.eq.5) namemodel1 = "SEISGLOB1"
       if (tomo1.eq.6) namemodel1 = "SP12RTS"
       if (tomo1.eq.7) namemodel1 = "SGLOBE"
       if (tomo1.eq.8) namemodel1 = "3D2016"
       if (tomo1.eq.9) namemodel1 = "MYMODEL"
       if (para1.eq.1) namepara1 = "VS"
       if (para1.eq.2) namepara1 = "VP"
       if (para1.eq.3) namepara1 = "RHO"
       if (tomo2.eq.1) namemodel2 = "SEISGLOB2"
       if (tomo2.eq.2) namemodel2 = "S40RTS"
       if (tomo2.eq.3) namemodel2 = "SEMUCBWM1"
       if (tomo2.eq.4) namemodel2 = "S362WMANIM"
       if (tomo2.eq.5) namemodel2 = "SEISGLOB1"
       if (tomo2.eq.6) namemodel2 = "SP12RTS"
       if (tomo2.eq.7) namemodel2 = "SGLOBE"
       if (tomo2.eq.8) namemodel2 = "3D2016"
       if (tomo2.eq.9) namemodel2 = "MYMODEL"
       if (para2.eq.1) namepara2 = "VS"
       if (para2.eq.2) namepara2 = "VP"
       if (para2.eq.3) namepara2 = "RHO"
       filemoi1=trim(adjustl(homedir))//
     + "input_files/map_NEW_"//trim(adjustl(namemodel1))//
     + "_"//trim(adjustl(namepara1))//"_"//trim(adjustl(namedepth1))//
     + ".xyz"
       filemoi3=trim(adjustl(homedir))//
     + "input_files/map_NEW_"//trim(adjustl(namemodel2))//
     + "_"//trim(adjustl(namepara2))//"_"//trim(adjustl(namedepth2))//
     + ".xyz"
       filemoi2=trim(adjustl(homedir))//"output_files_corr/corr_"//
     + trim(adjustl(namemodel1))//
     + "_"//trim(adjustl(namemodel2))//".xy"
