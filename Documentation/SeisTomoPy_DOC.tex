...
There is currently a problem with the projection in Maps when you want to change the center longitude. You can only use values from -180 to 0 degrees otherwise the projection fails. We are currently working on fixing this issue in the next version of SeisTomoPy.
