...
\verb?KeyError: 'PROJ_LIB'?\\
This is not related to SeisTomoPy and the solution seems to depend on the installation of conda and anaconda the user has. Many people reported that re-installing proj4 works 

\verb?$ conda install -c conda-forge  proj4?\\
We also found that it can be solved installing geopandas

\verb?$ conda install geopandas?\\
Please let us know if none of these solutions work.
...
\verb?$ cd SeisTomoPy_V3/Documentation/SeisTomoPy_notebook?
