...
setup_config = dict(
    ...
    install_requires=['numpy >= 1.11.0','obspy >= 1.0.1','scipy >= 0.17.0','pyqtgraph >= 0.9.10','basemap >= 1.0.7','matplotlib >= 2.0.2','pyproj=1.9.5.1','proj4=5.0.1','proj.4=4.9.1','geopandas=0.3.0'],
