...
if __name__ == "__main__":
    ...
    if sys.version_info[0] == 2:
        import urllib
        urllib.urlretrieve("http://perso.ens-lyon.fr/stephanie.durand/models.zip","models.zip")
    else:
        import urllib.request 
        urllib.request.urlretrieve("http://perso.ens-lyon.fr/stephanie.durand/models.zip","models.zip")
